...
documentation_page <- div(
    br(),
    p(strong("Introduction"), style = "font-size:2rem;"),
    ...
    br(),
    br(),
    p(strong("Apps Guideline"), style = "font-size:2rem;"),
      p("1. User can search the interested appliances in the search column." strong("Eg: Oven,Refrigerator, Washer, Dryer, Humifier"),
        br(),"User can choose to narrow the search by selecting the brand of ideal appliances.",
      ...
      br(),
      br(),
    p(strong("Future Works"), style = "font-size:2rem;font-family:times"),
    ...
    br(),
    br(),
    p(strong("Dataset"), style = "font-size:2rem;"),
