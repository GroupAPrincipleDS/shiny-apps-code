...
documentation_page <- div(
    br(),
    p(strong("Introduction"), style = "font-size:50px;"),
    ...
    br(),
    br(),
    p(strong("Apps Guideline"), style = "font-size:50px;"),
      ...
      br(),
      br(),
      p(strong("Dataset"), style = "font-size:50px;"),
    ...
    br(),
    br(),
    p(strong("Future Works"), style = "font-size:50px;font-family:times"),
